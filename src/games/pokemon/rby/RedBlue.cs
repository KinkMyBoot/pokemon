...
public class RedBlue : Rby {
    ...
    public RedBlue(string rom, string savFile = null, bool speedup = true) : base(rom, savFile, speedup ? SpeedupFlags.All : SpeedupFlags.None) { }
...
public class Blue : RedBlue {
    ...
    public Blue(string savFile = null, bool speedup = true) : base("roms/pokeblue.gbc", savFile, speedup) { }

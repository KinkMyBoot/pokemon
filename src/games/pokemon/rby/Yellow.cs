...
public class Yellow : Rby {
    ...
    public static readonly Dictionary<(string, byte), byte> wLastMapDestinations = new Dictionary<(string, byte), byte>() {
        ...
        { ("CeruleanMelaniesHouse", 1), 3 },
        { ("CeruleanMelaniesHouse", 0), 3 },
        { ("RedsHouse1F", 1), 0 },
        { ("Route2Gate", 2), 13 },
        { ("RedsHouse1F", 0), 0 },
        { ("Route2Gate", 3), 13 },
        ...
        { ("SummerBeachHouse", 0), 30 },
        { ("SummerBeachHouse", 1), 30 },
    };

    public Yellow(string savFile = null, bool speedup = true) : base("roms/pokeyellow.gbc", savFile, speedup ? SpeedupFlags.NoVideo | SpeedupFlags.NoSound : SpeedupFlags.None) { }
